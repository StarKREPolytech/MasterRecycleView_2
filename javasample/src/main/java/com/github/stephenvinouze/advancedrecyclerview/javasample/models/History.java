...
public final class History {
     ...
     * 3.) name указывает имя элемента, например: "Москва - Екатеринбург";
     * 4.) startTime указывает время начала сеанса, например: "21.01.2018 18:44";
     * 5.) endTime указывает время окончания сеанса, например: "21.01.2018 23:57".
     */
